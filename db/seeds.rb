...
being_mortal = Book.create(title: "The Expanse", author: "Atul Gawande", isbn: "5555555555555")
los_cocuyos = Book.create(title: "Crime and Punishment", author: "Richard Blanco", isbn: "5555555555555")
never_let = Book.create(title: "How to Tame a Unicorn", author: "Ishiguro Kazuo", isbn: "5555555555555")
thousand_splendid = Book.create(title: "Centaur Fancy", author: "Khaled Hosseini", isbn: "5555555555555")
bad_feminist = Book.create(title: "Wizard of Earthsea", author: "Roxane Gay", isbn: "5555555555555")
just_mercy = Book.create(title: "The Witcher", author: "Bryan Stevenson", isbn: "5555555555555")
citizen = Book.create(title: "Unicorn Abroad: A Love Story about one Unicorn and one Centaur", author: "Claudia Rankine", isbn: "5555555555555")
